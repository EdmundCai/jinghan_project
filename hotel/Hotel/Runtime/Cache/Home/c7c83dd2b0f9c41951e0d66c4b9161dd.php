            ...
            <div id="c_con">
                <div id="news">
                    ...
                    <?php if($cursor == publication): ?><div id="top">
                            <li><a href="<?php echo U('News/index?type=publication');?>" <?php if($choose != special): ?>class="top_check"<?php endif; ?>>精选文摘</a></li>
                            <li><a href="<?php echo U('News/book?type=publication&choose=special');?>" <?php if($choose == special): ?>class="top_check"<?php endif; ?>>专业会刊</a></li>
                            <li><a href="<?php echo U('News/book?type=publication&choose=download');?>" <?php if($choose == special): ?>class="top_check"<?php endif; ?>>会刊下载</a></li>     
                        </div><?php endif; ?>
