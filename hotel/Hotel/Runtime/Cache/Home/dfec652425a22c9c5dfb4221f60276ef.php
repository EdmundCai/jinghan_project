    ...
    <div id="content">
        <div id="all_con">
            ...
            <div id="c_left">
                <div id="next_nav">    
                    <ul>
                        <li <?php if($cursor == monthly): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Intelligence/index?type=monthly');?>">月度经营情报</a></li>
                        <li <?php if($cursor == yearly): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Intelligence/index?type=yearly');?>">年度经营情报</a></li>
                        <li <?php if($cursor == gjh): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Intelligence/index?type=gjh');?>">广交会经营情报</a></li>
                        <li <?php if($cursor == upload): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Intelligence/index?type=upload');?>">经营情报上传</a></li>
                    </ul>
                </div>
                <div id="divh"></div>
            </div>
            <div id="c_con">
                <div id="intelligence">
                    <ul id="news_list">
                        ...
                        <li><a href="">第100届XXXXXXXXX经营情况 <span class="date">2016-2-1</span></a></li>
                        <li><a href="">第100届XXXXXXXXX经营情况 <span class="date">2016-2-1</span></a></li>
                        <li><a href="">第100届XXXXXXXXX经营情况 <span class="date">2016-2-1</span></a></li>
                        <li><a href="">第100届XXXXXXXXX经营情况 <span class="date">2016-2-1</span></a></li>
                        <li><a href="">第100届XXXXXXXXX经营情况 <span class="date">2016-2-1</span></a></li>
