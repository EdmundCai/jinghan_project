...
<meta name="description" content="广州地区酒店行业协会,使命与目标">
<meta name="keywords" content="广州地区酒店行业协会,使命与目标">
...
<div id="div27"></div>
    ...
    <div id="content">
        <div id="all_con">
            <div id="c_nav" style="margin-left:-12px;"><b>使命与目标</b></div>
            <div id="c_left">
                <div id="next_nav" style="">                    
                    <ul class="dropdown">
    <li <?php if($cursor == mission): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=mission');?>">协会使命</a></li>
    <li <?php if($cursor == rules): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=rules');?>">协会章程</a></li>
    <li <?php if($cursor == joinUs): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=joinUs');?>">加入我们</a></li>
    <li class="vtitle">
        <a>协会会员</a>
        <ul <?php if($tap != member): ?>style="display:none;"<?php endif; ?>>
           <li <?php if($cursor == chairman): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=chairman');?>">会长单位</a></li>
           <li <?php if($cursor == vice_chairman): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=vice_chairman');?>">副会长单位</a></li>
           <li <?php if($cursor == st_council): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=st_council');?>">常务理事单位</a></li>
           <li <?php if($cursor == council): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=council');?>">理事单位</a></li>
           <li <?php if($cursor == member): ?>class="checkedli"<?php endif; ?>><a href="<?php echo U('Goals/index?type=member');?>">会员单位</a></li>
        </ul>
    </li>
</ul>
